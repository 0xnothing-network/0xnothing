export const PixelNFTABI = [
  ...
  {
    "inputs": [{ "name": "px", "type": "string" }, { "name": "grid", "type": "uint256" }],
    "name": "checkOriginal",
  ...
  {
    "inputs": [{ "name": "id", "type": "uint256" }, { "name": "price", "type": "uint256" }],
    "name": "listForSale",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  ...
  {
    "inputs": [{ "name": "name", "type": "string" }, { "name": "desc", "type": "string" }, { "name": "grid", "type": "uint256" }, { "name": "px", "type": "string" }],
    "name": "mint",
    "outputs": [{ "name": "", "type": "uint256" }],
    "stateMutability": "nonpayable",
    "type": "function"
